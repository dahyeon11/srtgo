...
public enum EnumC3364kC0 implements InterfaceC2650dz0 {
    UNSPECIFIED(0),
    CMD_DONT_PROCEED(1),
    CMD_PROCEED(2),
    ...
    private static final InterfaceC2765ez0 f20373b = new InterfaceC2765ez0() { // from class: com.google.android.gms.internal.ads.iC0
        @Override // com.google.android.gms.internal.ads.InterfaceC2765ez0
        public final /* synthetic */ InterfaceC2650dz0 zza(int i8) {
            return EnumC3364kC0.zzb(i8);
        }
    };
    ...
    public static EnumC3364kC0 zzb(int i8) {
        switch (i8) {
            case 0:
                return UNSPECIFIED;
            case 1:
    ...
    public final String toString() {
        return Integer.toString(this.f20375a);
    }
