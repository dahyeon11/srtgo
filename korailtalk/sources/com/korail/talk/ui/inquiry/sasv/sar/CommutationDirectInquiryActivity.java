...
public class CommutationDirectInquiryActivity extends AbstractActivityC5830c {
    ...
    public void onClick(View view) {
        ...
        if (i8 > -1) {
            ...
            if (N.isNotNull(string)) {
                C6637k.getCDialog(K(), 1001, 0, getString(AbstractC5959j.dialog_title)).setContent(string).setButtonListener(new DialogInterface.OnClickListener() { // from class: n5.b
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i9) {
                        this.f34262a.t2(dialogInterface, i9);
                    }
                }).showDialog();
            } else {
                K0();
