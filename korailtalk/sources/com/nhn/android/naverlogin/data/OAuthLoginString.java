...
public enum OAuthLoginString {
    ...
    public String getString(Context context) throws ClassNotFoundException, SecurityException {
        try {
            Integer num = 0;
            Class<?> cls = Class.forName(context.getPackageName() + ".R$string");
            for (Field field : cls.getDeclaredFields()) {
                field.setAccessible(true);
                if (field.getName().equals(this.f29649a)) {
        ...
        try {
            ...
            try {
                ...
                if ("zh".equalsIgnoreCase(language)) {
                    return "TW".equalsIgnoreCase(country) ? this.f29653e : this.f29652d;
                }
            } catch (Exception e8) {
                e8.printStackTrace();
            }
