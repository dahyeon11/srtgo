    ...
    public enum LogType {
        ...
        public Log createLog(String str) {
            try {
                ...
                localLog.log(Log.Level.WARNING, "Unable to call constructor with single String argument for class " + this.logClassName + ", so had to use local log: " + e8.getMessage());
                return localLog;
            }
        }
        ...
        boolean isAvailableTestClass() throws ClassNotFoundException {
            try {
