...
public class LocalLog implements Log {
        ...
        if (levelValueOf == null) {
            ...
            if (property == null) {
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Level '" + property + "' was not found", e8);
                }
            }
        }
    ...
    public static void openLogFile(String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Log file " + str + " was not found", e8);
        }
    }
    ...
    static List<PatternLevel> readLevelResourceFile(InputStream inputStream) throws IOException {
        try {
            if (inputStream != null) {
                try {
                    ...
                    System.err.println("IO exception reading the log properties file '/ormliteLocalLog.properties': " + e8);
                    try {
                        inputStream.close();
