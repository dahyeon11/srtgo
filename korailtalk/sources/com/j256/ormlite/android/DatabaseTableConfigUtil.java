...
public class DatabaseTableConfigUtil {
    ...
    private static void assignConfigField(int i8, DatabaseFieldConfig databaseFieldConfig, Field field, Object obj) {
        switch (i8) {
            case 1:
            ...
            case 29:
                ...
                return;
            default:
                throw new IllegalStateException("Could not find support for DatabaseField number " + i8);
        }
    }

    private static DatabaseFieldConfig buildConfig(DatabaseField databaseField, String str, Field field) throws IllegalAccessException, IllegalArgumentException {
        Object obj;
        ...
        while (true) {
            ...
            Object obj2 = valueField.get(objArr[i8]);
            if (obj2 != null) {
                assignConfigField(iArr[i8], databaseFieldConfig, field, obj2);
            }
            i8++;
        }
    }
    ...
    private static int[] lookupClasses() throws NoSuchFieldException, ClassNotFoundException, SecurityException, IllegalArgumentException {
        Object obj;
        try {
            ...
            if (invocationHandler.getClass() == annotationFactoryClazz && (obj = elementsField.get(invocationHandler)) != null && obj.getClass() == cls) {
                ...
                for (int i8 = 0; i8 < objArr.length; i8++) {
                    iArr[i8] = configFieldNameToNum((String) nameField.get(objArr[i8]));
                }
                return iArr;
            }
