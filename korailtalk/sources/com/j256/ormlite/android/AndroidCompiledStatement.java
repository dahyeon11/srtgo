...
public class AndroidCompiledStatement implements CompiledStatement {
    ...
    public AndroidCompiledStatement(String str, SQLiteDatabase sQLiteDatabase, StatementBuilder.StatementType statementType, boolean z8) {
        this.sql = str;
        this.db = sQLiteDatabase;
        this.type = statementType;
        this.cancelQueriesEnabled = z8;
    }

    static int execSql(SQLiteDatabase sQLiteDatabase, String str, String str2, Object[] objArr) throws SQLException, android.database.SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Problems executing " + str + " Android statement: " + str2, e8);
        }
    }
    ...
    public void close() throws SQLException {
        ...
        if (cursor != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Problems closing Android cursor", e8);
            }
        }
    ...
    public String getColumnName(int i8) {
        return getCursor().getColumnName(i8);
    }
    ...
    public Cursor getCursor() throws SQLException {
        if (this.cursor == null) {
            ...
            try {
                ...
                throw SqlExceptionUtil.create("Problems executing Android query: " + str, e8);
            }
        }
        return this.cursor;
    }
    ...
    public void setObject(int i8, Object obj, SqlType sqlType) throws SQLException {
        ...
        switch (AnonymousClass1.$SwitchMap$com$j256$ormlite$field$SqlType[sqlType.ordinal()]) {
            ...
            case 10:
            case 11:
                this.args.add(i8, obj.toString());
                return;
            case 12:
            case 13:
                this.args.add(i8, obj);
                return;
            case 14:
            case 15:
    ...
    @Override // com.j256.ormlite.support.CompiledStatement
    public void setQueryTimeout(long j8) {
    }
