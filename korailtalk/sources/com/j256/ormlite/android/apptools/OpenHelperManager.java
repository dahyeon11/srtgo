    ...
    private static OrmLiteSqliteOpenHelper constructHelper(Context context, Class<? extends OrmLiteSqliteOpenHelper> cls) {
        try {
            try {
                ...
                throw new IllegalStateException("Could not construct instance of helper class " + cls, e8);
            }
        } catch (Exception e9) {
            throw new IllegalStateException("Could not find public constructor that has a single (Context) argument for helper class " + cls, e9);
        }
    }
    ...
    private static Class<? extends OrmLiteSqliteOpenHelper> lookupHelperClass(Context context, Class<?> cls) throws Resources.NotFoundException {
        ...
        if (identifier != 0) {
            ...
            try {
                ...
                throw new IllegalStateException("Could not create helper instance for class " + string, e8);
            }
        }
    ...
    public static synchronized void releaseHelper() {
        try {
            ...
            if (instanceCount <= 0) {
                ...
                int i8 = instanceCount;
                if (i8 < 0) {
                    logger.error("too many calls to release helper, instance count = {}", Integer.valueOf(i8));
                }
            }
        } catch (Throwable th) {
            throw th;
