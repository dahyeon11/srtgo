...
public abstract class OrmLiteBaseActivity<H extends OrmLiteSqliteOpenHelper> extends Activity {
    ...
    protected H getHelperInternal(Context context) {
        H h8 = (H) OpenHelperManager.getHelper(context);
        logger.trace("{}: got new helper {} from OpenHelperManager", this, h8);
        return h8;
    }
    ...
    protected void releaseHelper(H h8) {
        OpenHelperManager.releaseHelper();
        logger.trace("{}: helper {} was released, set to null", this, h8);
        this.helper = null;
    }
