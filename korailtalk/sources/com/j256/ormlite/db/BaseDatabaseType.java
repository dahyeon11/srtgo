...
public abstract class BaseDatabaseType implements DatabaseType {
    ...
    protected static class BooleanNumberFieldConverter extends BaseFieldConverter {
        ...
        public Object resultStringToJava(FieldType fieldType, String str, int i8) {
            return sqlArgToJava(fieldType, Byte.valueOf(Byte.parseByte(str)), i8);
        }

        @Override // com.j256.ormlite.field.FieldConverter
        public Object resultToSqlArg(FieldType fieldType, DatabaseResults databaseResults, int i8) {
            return Byte.valueOf(databaseResults.getByte(i8));
        }
    ...
    private void appendDoubleType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("DOUBLE PRECISION");
    }

    private void appendFloatType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("FLOAT");
    }

    private void appendIntegerType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("INTEGER");
    }
    ...
    protected void appendBigDecimalNumericType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("NUMERIC");
    }

    protected void appendBooleanType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("BOOLEAN");
    }

    protected void appendByteArrayType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("BLOB");
    }

    protected void appendByteType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("TINYINT");
    }

    protected void appendCharType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("CHAR");
    }
    ...
    protected void appendDateType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("TIMESTAMP");
    }
    ...
    @Override // com.j256.ormlite.db.DatabaseType
    public void appendLimitValue(StringBuilder sb, long j8, Long l8) {
        sb.append("LIMIT ");
        sb.append(j8);
        sb.append(' ');
    }

    protected void appendLongStringType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append(MapIf.E_TEXT);
    }
    ...
    @Override // com.j256.ormlite.db.DatabaseType
    public void appendOffsetValue(StringBuilder sb, long j8) {
        sb.append("OFFSET ");
        sb.append(j8);
        sb.append(' ');
    }
    ...
    protected void appendSerializableType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("BLOB");
    }

    protected void appendShortType(StringBuilder sb, FieldType fieldType, int i8) {
        sb.append("SMALLINT");
    }

    protected void appendStringType(StringBuilder sb, FieldType fieldType, int i8) {
    ...
    public void loadDriver() throws SQLException, ClassNotFoundException {
        ...
        if (driverClassName != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Driver class was not found for " + getDatabaseName() + " database.  Missing jar with class " + driverClassName + ".", e8);
            }
        }
    }
