...
public class DateType extends BaseDateType {
    ...
    public Object parseDefaultString(FieldType fieldType, String str) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Problems parsing default date string '" + str + "' using '" + dateStringFormatConfigConvertDateStringConfig + '\'', e8);
        }
    }

    @Override // com.j256.ormlite.field.types.BaseDataType, com.j256.ormlite.field.FieldConverter
    public Object resultToSqlArg(FieldType fieldType, DatabaseResults databaseResults, int i8) {
        return databaseResults.getTimestamp(i8);
    }
