...
public class FieldType {
    ...
    static class AnonymousClass1 extends ThreadLocal<LevelCounters> {
        AnonymousClass1() {
        }
    ...
    public FieldType(ConnectionSource connectionSource, String str, Field field, DatabaseFieldConfig databaseFieldConfig, Class<?> cls) throws IllegalAccessException, SQLException, SecurityException, IllegalArgumentException, InvocationTargetException {
                ...
                try {
                    try {
                        ...
                        try {
                            ...
                            throw SqlExceptionUtil.create("Could not cast result of static getSingleton method to DataPersister from class " + persisterClass, e8);
                        }
                    } catch (InvocationTargetException e9) {
                        throw SqlExceptionUtil.create("Could not run getSingleton method on class " + persisterClass, e9.getTargetException());
                    } catch (Exception e10) {
                        throw SqlExceptionUtil.create("Could not run getSingleton method on class " + persisterClass, e10);
                    }
                } catch (Exception e11) {
                    throw SqlExceptionUtil.create("Could not find getSingleton static method on class " + persisterClass, e11);
                }
            }
        } else {
    ...
    public void assignField(Object obj, Object obj2, boolean z8, ObjectCache objectCache) throws SQLException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
                ...
                if (levelCounters.autoRefreshLevel >= levelCounters.autoRefreshLevelMax) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            int i8 = levelCounters.autoRefreshLevel - 1;
                            levelCounters.autoRefreshLevel = i8;
                            if (i8 <= 0) {
                                threadLocal.remove();
                            }
                        } finally {
                        ...
                        int i9 = levelCounters.autoRefreshLevel - 1;
                        levelCounters.autoRefreshLevel = i9;
                        if (i9 <= 0) {
        ...
        if (method != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Could not call " + this.fieldSetMethod + " on object with '" + obj2 + "' for " + this, e8);
            }
        }
        try {
            this.field.set(obj, obj2);
        } catch (IllegalAccessException e9) {
            throw SqlExceptionUtil.create("Could not assign object '" + obj2 + "' to field " + this, e9);
        } catch (IllegalArgumentException e10) {
            throw SqlExceptionUtil.create("Could not assign object '" + obj2 + "' to field " + this, e10);
        }
    }
    ...
    public <FT, FID> BaseForeignCollection<FT, FID> buildForeignCollection(Object obj, FID fid) {
        ...
        int i8 = levelCounters.foreignCollectionLevel;
        if (i8 >= levelCounters.foreignCollectionLevelMax) {
            return new LazyForeignCollection(baseDaoImpl, obj, fid, this.foreignFieldType, this.fieldConfig.getForeignCollectionOrderColumnName(), this.fieldConfig.isForeignCollectionOrderAscending());
        }
        levelCounters.foreignCollectionLevel = i8 + 1;
        try {
    ...
    public Object convertStringToJavaField(String str, int i8) {
        if (str == null) {
            return null;
        }
        return this.fieldConverter.resultStringToJava(this, str, i8);
    }

    public <T> int createWithForeignDao(T t8) {
        return this.foreignDao.create(t8);
    }
    ...
    public <FV> FV extractRawJavaFieldValue(Object obj) throws SQLException {
        ...
        if (method == null) {
            try {
                ...
                throw SqlExceptionUtil.create("Could not get field value for " + this, e8);
            }
        }
        try {
            return (FV) method.invoke(obj, null);
        } catch (Exception e9) {
            throw SqlExceptionUtil.create("Could not call " + this.fieldGetMethod + " for " + this, e9);
        }
    }
    ...
    public <T> T resultToJava(DatabaseResults databaseResults, Map<String, Integer> map) throws SQLException {
        ...
        T t8 = (T) this.fieldConverter.resultToJava(this, databaseResults, numValueOf.intValue());
