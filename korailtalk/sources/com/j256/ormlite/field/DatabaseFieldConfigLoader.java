    ...
    */
    public static com.j256.ormlite.field.DatabaseFieldConfig fromReader(java.io.BufferedReader r6) throws java.sql.SQLException, java.io.IOException {
        /*
            ...
            r2 = r1
        L7:
            java.lang.String r3 = r6.readLine()     // Catch: java.io.IOException -> L5e
            if (r3 != 0) goto Le
            goto L16
        Le:
    ...
    public static void write(BufferedWriter bufferedWriter, DatabaseFieldConfig databaseFieldConfig, String str) throws SQLException {
        try {
            ...
            throw SqlExceptionUtil.create("Could not write config to writer", e8);
        }
    }
    ...
    public static void writeConfig(BufferedWriter bufferedWriter, DatabaseFieldConfig databaseFieldConfig, String str) throws IOException {
        ...
        if (databaseFieldConfig.isId()) {
            bufferedWriter.append("id").append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isGeneratedId()) {
            bufferedWriter.append(FIELD_NAME_GENERATED_ID).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isForeign()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isUseGetSet()) {
            bufferedWriter.append(FIELD_NAME_USE_GET_SET).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isThrowIfNull()) {
            bufferedWriter.append(FIELD_NAME_THROW_IF_NULL).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isUnique()) {
            bufferedWriter.append(FIELD_NAME_UNIQUE).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isUniqueCombo()) {
            bufferedWriter.append(FIELD_NAME_UNIQUE_COMBO).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isForeignAutoRefresh()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN_AUTO_REFRESH).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isAllowGeneratedIdInsert()) {
            bufferedWriter.append(FIELD_NAME_ALLOW_GENERATED_ID_INSERT).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isForeignAutoCreate()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN_AUTO_CREATE).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isVersion()) {
            bufferedWriter.append(FIELD_NAME_VERSION).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        ...
        if (databaseFieldConfig.isReadOnly()) {
            bufferedWriter.append(FIELD_NAME_READ_ONLY).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isForeignCollection()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN_COLLECTION).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
        if (databaseFieldConfig.isForeignCollectionEager()) {
            bufferedWriter.append(FIELD_NAME_FOREIGN_COLLECTION_EAGER).append('=').append(C0709m.TRUE);
            bufferedWriter.newLine();
        }
