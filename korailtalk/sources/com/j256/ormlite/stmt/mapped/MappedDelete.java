...
public class MappedDelete<T, ID> extends BaseMappedStatement<T, ID> {
    ...
    public int delete(DatabaseConnection databaseConnection, T t8, ObjectCache objectCache) throws SQLException {
        try {
            ...
            if (iDelete > 0 && objectCache != 0) {
                objectCache.remove(this.clazz, this.idField.extractJavaFieldToSqlArgValue(t8));
            }
            return iDelete;
        } catch (SQLException e8) {
            throw SqlExceptionUtil.create("Unable to run delete stmt on object " + t8 + ": " + this.statement, e8);
        }
    }
    ...
    public int deleteById(DatabaseConnection databaseConnection, ID id, ObjectCache objectCache) throws SQLException {
        try {
            ...
            throw SqlExceptionUtil.create("Unable to run deleteById stmt on id " + id + ": " + this.statement, e8);
        }
    }
}
