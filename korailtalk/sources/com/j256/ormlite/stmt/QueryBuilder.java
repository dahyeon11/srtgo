...
public class QueryBuilder<T, ID> extends StatementBuilder<T, ID> {
        ...
        if (list != null) {
            for (QueryBuilder<T, ID>.JoinInfo joinInfo : list) {
                ...
                if (queryBuilder != null && queryBuilder.hasGroupStuff()) {
                    joinInfo.queryBuilder.appendGroupBys(sb, z8);
                }
            }
        }
    }
        ...
        if (list2 != null) {
            for (QueryBuilder<T, ID>.JoinInfo joinInfo : list2) {
                ...
                if (queryBuilder != null && queryBuilder.hasOrderStuff()) {
                    joinInfo.queryBuilder.appendOrderBys(sb, z8, list);
                }
            }
        }
    }
    ...
    private void setAddTableName(boolean z8) {
        this.addTableName = z8;
        List<QueryBuilder<T, ID>.JoinInfo> list = this.joinList;
        if (list != null) {
            Iterator<QueryBuilder<T, ID>.JoinInfo> it = list.iterator();
            while (it.hasNext()) {
                it.next().queryBuilder.setAddTableName(z8);
            }
        }
    }
    ...
    @Override // com.j256.ormlite.stmt.StatementBuilder
    protected boolean appendWhereStatement(StringBuilder sb, List<ArgumentHolder> list, StatementBuilder.WhereOperation whereOperation) {
    ...
    @Deprecated
    public QueryBuilder<T, ID> limit(int i8) {
        return limit(Long.valueOf(i8));
    }

    @Deprecated
    public QueryBuilder<T, ID> offset(int i8) {
        return offset(Long.valueOf(i8));
    }

    public QueryBuilder<T, ID> orderBy(String str, boolean z8) {
        if (verifyColumnName(str).isForeignCollection()) {
        ...
        this.orderByList.add(new OrderBy(str, z8));
        return this;
    }
    ...
    public QueryBuilder<T, ID> setCountOf(boolean z8) {
        this.isCountOfQuery = z8;
        return this;
    }
    ...
    public QueryBuilder<T, ID> limit(Long l8) {
        this.limit = l8;
        return this;
    }

    public QueryBuilder<T, ID> offset(Long l8) throws SQLException {
    ...
    private void appendGroupBys(StringBuilder sb, boolean z8) {
        if (z8) {
            sb.append("GROUP BY ");
        }
    ...
    private void appendOrderBys(StringBuilder sb, boolean z8, List<ArgumentHolder> list) {
        if (z8) {
            sb.append("ORDER BY ");
        }
