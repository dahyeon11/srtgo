...
public class LruObjectCache implements ObjectCache {
    ...
    private static class LimitedLinkedHashMap<K, V> extends LinkedHashMap<K, V> {
        ...
        public LimitedLinkedHashMap(int i8) {
            super(i8, 0.75f, true);
            this.capacity = i8;
        }
    ...
    @Override // com.j256.ormlite.dao.ObjectCache
    public <T, ID> void put(Class<T> cls, ID id, T t8) {
        Map<Object, Object> mapForClass = getMapForClass(cls);
        if (mapForClass != null) {
            mapForClass.put(id, t8);
        }
    }
    ...
    public <T, ID> T updateId(Class<T> cls, ID id, ID id2) {
        T t8;
        Map<Object, Object> mapForClass = getMapForClass(cls);
        if (mapForClass == null || (t8 = (T) mapForClass.remove(id)) == null) {
            return null;
        }
        mapForClass.put(id2, t8);
        return t8;
    }
}
