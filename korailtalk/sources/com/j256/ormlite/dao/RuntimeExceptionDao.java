...
public class RuntimeExceptionDao<T, ID> implements CloseableIterable<T> {
    ...
    public void assignEmptyForeignCollection(T t8, String str) {
        try {
            this.dao.assignEmptyForeignCollection(t8, str);
        } catch (SQLException e8) {
            logMessage(e8, "assignEmptyForeignCollection threw exception on " + str);
    ...
    public <CT> CT callBatchTasks(Callable<CT> callable) {
        try {
            ...
            logMessage(e8, "callBatchTasks threw exception on: " + callable);
            throw new RuntimeException(e8);
        }
    }
    ...
    public void closeLastIterator() {
        try {
            ...
            logMessage(e8, "closeLastIterator threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public void commit(DatabaseConnection databaseConnection) {
        try {
            ...
            logMessage(e8, "commit(" + databaseConnection + ") threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public long countOf() {
        try {
            ...
            logMessage(e8, "countOf threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public int create(T t8) {
        try {
            return this.dao.create(t8);
        } catch (SQLException e8) {
            logMessage(e8, "create threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public T createIfNotExists(T t8) {
        try {
            return this.dao.createIfNotExists(t8);
        } catch (SQLException e8) {
            logMessage(e8, "createIfNotExists threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }

    public Dao.CreateOrUpdateStatus createOrUpdate(T t8) {
        try {
            return this.dao.createOrUpdate(t8);
        } catch (SQLException e8) {
            logMessage(e8, "createOrUpdate threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int delete(T t8) {
        try {
            return this.dao.delete((Dao<T, ID>) t8);
        } catch (SQLException e8) {
            logMessage(e8, "delete threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int deleteById(ID id) {
        try {
            ...
            logMessage(e8, "deleteById threw exception on: " + id);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int deleteIds(Collection<ID> collection) {
        try {
            ...
            logMessage(e8, "deleteIds threw exception on: " + collection);
            throw new RuntimeException(e8);
        }
    }
    ...
    public void endThreadConnection(DatabaseConnection databaseConnection) {
        try {
            ...
            logMessage(e8, "endThreadConnection(" + databaseConnection + ") threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public int executeRaw(String str, String... strArr) {
        try {
            ...
            logMessage(e8, "executeRaw threw exception on: " + str);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int executeRawNoArgs(String str) {
        try {
            ...
            logMessage(e8, "executeRawNoArgs threw exception on: " + str);
            throw new RuntimeException(e8);
        }
    }

    public ID extractId(T t8) {
        try {
            return this.dao.extractId(t8);
        } catch (SQLException e8) {
            logMessage(e8, "extractId threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public <FT> ForeignCollection<FT> getEmptyForeignCollection(String str) {
        try {
            ...
            logMessage(e8, "getEmptyForeignCollection threw exception on " + str);
            throw new RuntimeException(e8);
        }
    }
    ...
    public GenericRowMapper<T> getSelectStarRowMapper() {
        try {
            ...
            logMessage(e8, "getSelectStarRowMapper threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public boolean idExists(ID id) {
        try {
            ...
            logMessage(e8, "idExists threw exception on " + id);
            throw new RuntimeException(e8);
        }
    }
    ...
    public boolean isAutoCommit() {
        try {
            ...
            logMessage(e8, "isAutoCommit() threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public boolean isTableExists() {
        try {
            ...
            logMessage(e8, "isTableExists threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public T mapSelectStarRow(DatabaseResults databaseResults) {
        try {
            ...
            logMessage(e8, "mapSelectStarRow threw exception on results");
            throw new RuntimeException(e8);
        }
    }

    public String objectToString(T t8) {
        return this.dao.objectToString(t8);
    }

    public boolean objectsEqual(T t8, T t9) {
        try {
            return this.dao.objectsEqual(t8, t9);
        } catch (SQLException e8) {
            logMessage(e8, "objectsEqual threw exception on: " + t8 + " and " + t9);
            throw new RuntimeException(e8);
        }
    }
    ...
    public List<T> query(PreparedQuery<T> preparedQuery) {
        try {
            ...
            logMessage(e8, "query threw exception on: " + preparedQuery);
            throw new RuntimeException(e8);
        }
    }
    ...
    public List<T> queryForAll() {
        try {
            ...
            logMessage(e8, "queryForAll threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public List<T> queryForEq(String str, Object obj) {
        try {
            ...
            logMessage(e8, "queryForEq threw exception on: " + str);
            throw new RuntimeException(e8);
        }
    }
    ...
    public List<T> queryForFieldValues(Map<String, Object> map) {
        try {
            ...
            logMessage(e8, "queryForFieldValues threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public List<T> queryForFieldValuesArgs(Map<String, Object> map) {
        try {
            ...
            logMessage(e8, "queryForFieldValuesArgs threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public T queryForFirst(PreparedQuery<T> preparedQuery) {
        try {
            ...
            logMessage(e8, "queryForFirst threw exception on: " + preparedQuery);
            throw new RuntimeException(e8);
        }
    }
    ...
    public T queryForId(ID id) {
        try {
            ...
            logMessage(e8, "queryForId threw exception on: " + id);
            throw new RuntimeException(e8);
        }
    }
    ...
    public List<T> queryForMatching(T t8) {
        try {
            return this.dao.queryForMatching(t8);
        } catch (SQLException e8) {
            logMessage(e8, "queryForMatching threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public List<T> queryForMatchingArgs(T t8) {
        try {
            return this.dao.queryForMatchingArgs(t8);
        } catch (SQLException e8) {
            logMessage(e8, "queryForMatchingArgs threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public T queryForSameId(T t8) {
        try {
            return this.dao.queryForSameId(t8);
        } catch (SQLException e8) {
            logMessage(e8, "queryForSameId threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public GenericRawResults<String[]> queryRaw(String str, String... strArr) {
        try {
            ...
            logMessage(e8, "queryRaw threw exception on: " + str);
            throw new RuntimeException(e8);
        }
    }
    ...
    public long queryRawValue(String str, String... strArr) {
        try {
            ...
            logMessage(e8, "queryRawValue threw exception on: " + str);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int refresh(T t8) {
        try {
            return this.dao.refresh(t8);
        } catch (SQLException e8) {
            logMessage(e8, "refresh threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public void rollBack(DatabaseConnection databaseConnection) {
        try {
            ...
            logMessage(e8, "rollBack(" + databaseConnection + ") threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public void setAutoCommit(boolean z8) {
        try {
            this.dao.setAutoCommit(z8);
        } catch (SQLException e8) {
            logMessage(e8, "setAutoCommit(" + z8 + ") threw exception");
            throw new RuntimeException(e8);
        }
    }

    public void setObjectCache(boolean z8) {
        try {
            this.dao.setObjectCache(z8);
        } catch (SQLException e8) {
            logMessage(e8, "setObjectCache(" + z8 + ") threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public DatabaseConnection startThreadConnection() {
        try {
            ...
            logMessage(e8, "startThreadConnection() threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public int update(T t8) {
        try {
            return this.dao.update((Dao<T, ID>) t8);
        } catch (SQLException e8) {
            logMessage(e8, "update threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int updateId(T t8, ID id) {
        try {
            return this.dao.updateId(t8, id);
        } catch (SQLException e8) {
            logMessage(e8, "updateId threw exception on: " + t8);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int updateRaw(String str, String... strArr) {
        try {
            ...
            logMessage(e8, "updateRaw threw exception on: " + str);
            throw new RuntimeException(e8);
        }
    }
    ...
    public long countOf(PreparedQuery<T> preparedQuery) {
        try {
            ...
            logMessage(e8, "countOf threw exception on " + preparedQuery);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int delete(Collection<T> collection) {
        try {
            ...
            logMessage(e8, "delete threw exception on: " + collection);
            throw new RuntimeException(e8);
        }
    }
    ...
    public boolean isAutoCommit(DatabaseConnection databaseConnection) {
        try {
            ...
            logMessage(e8, "isAutoCommit(" + databaseConnection + ") threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public CloseableIterator<T> iterator(PreparedQuery<T> preparedQuery) {
        try {
            ...
            logMessage(e8, "iterator threw exception on: " + preparedQuery);
            throw new RuntimeException(e8);
        }
    }
    ...
    public void setAutoCommit(DatabaseConnection databaseConnection, boolean z8) {
        try {
            this.dao.setAutoCommit(databaseConnection, z8);
        } catch (SQLException e8) {
            logMessage(e8, "setAutoCommit(" + databaseConnection + "," + z8 + ") threw exception");
            throw new RuntimeException(e8);
        }
    }
    ...
    public void setObjectCache(ObjectCache objectCache) {
        try {
            ...
            logMessage(e8, "setObjectCache threw exception on " + objectCache);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int update(PreparedUpdate<T> preparedUpdate) {
        try {
            ...
            logMessage(e8, "update threw exception on: " + preparedUpdate);
            throw new RuntimeException(e8);
        }
    }
    ...
    public int delete(PreparedDelete<T> preparedDelete) {
        try {
            ...
            logMessage(e8, "delete threw exception on: " + preparedDelete);
            throw new RuntimeException(e8);
        }
    }

    public CloseableIterator<T> iterator(PreparedQuery<T> preparedQuery, int i8) {
        try {
            return this.dao.iterator(preparedQuery, i8);
        } catch (SQLException e8) {
            logMessage(e8, "iterator threw exception on: " + preparedQuery);
            throw new RuntimeException(e8);
        }
