...
public abstract class a {
    public static AttributeSet parseDrawableXml(Context context, int i8, CharSequence charSequence) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
        try {
    ...
    public static void setRippleDrawableRadius(RippleDrawable rippleDrawable, int i8) {
