...
final class m {
    ...
    private final List f5337a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    private final List f5338b = new ArrayList();

    m() {
    }

    private void a(int[] iArr, String str) {
        this.f5337a.add(iArr);
        this.f5338b.add(str);
    }
    ...
    private synchronized void b() {
        if (this.f5337a.isEmpty()) {
            ...
            a(new int[]{com.google.firebase.iid.w.ERROR_UNKNOWN, Map.MapException.StatusCode.GRPC_AUTH_UPDATE_USER_SETTINGS_ERROR_VALUE}, "GB");
            a(new int[]{520}, "GR");
            a(new int[]{528}, "LB");
            a(new int[]{529}, "CY");
            a(new int[]{531}, "MK");
            ...
            a(new int[]{608}, "BH");
            a(new int[]{609}, "MU");
            a(new int[]{611}, y1.x.MAX_AD_CONTENT_RATING_MA);
            a(new int[]{613}, "DZ");
            a(new int[]{616}, "KE");
            a(new int[]{618}, "CI");
            a(new int[]{619}, "TN");
    ...
    String c(String str) throws NumberFormatException {
        ...
        for (int i10 = 0; i10 < size && i9 >= (i8 = (iArr = (int[]) this.f5337a.get(i10))[0]); i10++) {
            if (iArr.length != 1) {
                i8 = iArr[1];
            }
            if (i9 <= i8) {
                return (String) this.f5338b.get(i10);
            }
        }
        return null;
    }
