...
public abstract class AbstractC5376a {
    public static final <T extends Annotation> KClass<? extends T> getAnnotationClass(T t8) {
        Intrinsics.checkNotNullParameter(t8, "<this>");
        Class<? extends Annotation> clsAnnotationType = t8.annotationType();
    ...
    public static final <T> Class<T> getJavaClass(T t8) {
        Intrinsics.checkNotNullParameter(t8, "<this>");
        Class<T> cls = (Class<T>) t8.getClass();
