...
class h {
    ...
    private void a(int i8, int i9, byte b9) {
        ...
        while (b9 > 8) {
            b9 = (byte) (b9 - 8);
            int i10 = (i9 >>> b9) & 255;
            if (aVar2.f2964a == null) {
                throw new IllegalStateException("invalid dictionary: prefix not unique");
            }
            if (aVar2.f2964a[i10] == null) {
                aVar2.f2964a[i10] = new a();
            }
            aVar2 = aVar2.f2964a[i10];
        }
        int i11 = 8 - b9;
        int i12 = (i9 << i11) & 255;
        int i13 = 1 << i11;
        for (int i14 = i12; i14 < i12 + i13; i14++) {
            aVar2.f2964a[i14] = aVar;
        }
    }
    ...
    byte[] c(byte[] bArr) {
        ...
        for (byte b9 : bArr) {
            ...
            i9 += 8;
            while (i9 >= 8) {
                aVar = aVar.f2964a[(i8 >>> (i9 - 8)) & 255];
                if (aVar.f2964a == null) {
                    byteArrayOutputStream.write(aVar.f2965b);
                    i9 -= aVar.f2966c;
                    aVar = this.f2963a;
                } else {
                    i9 -= 8;
        ...
        while (i9 > 0) {
            a aVar2 = aVar.f2964a[(i8 << (8 - i9)) & 255];
            if (aVar2.f2964a != null || aVar2.f2966c > i9) {
                break;
            }
            byteArrayOutputStream.write(aVar2.f2965b);
            i9 -= aVar2.f2966c;
            aVar = this.f2963a;
        }
    ...
    void d(byte[] bArr, OutputStream outputStream) throws IOException {
        ...
        if (i8 > 0) {
            outputStream.write((int) ((j8 << (8 - i8)) | (255 >>> i8)));
        }
    }
