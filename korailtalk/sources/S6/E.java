...
public final class E implements List, Serializable, RandomAccess, KMappedMarker {
    ...
    public Void get(int i8) {
        throw new IndexOutOfBoundsException("Empty list doesn't contain element at index " + i8 + Q7.C.PACKAGE_SEPARATOR_CHAR);
    }
