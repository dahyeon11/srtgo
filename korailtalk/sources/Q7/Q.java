...
public class Q {
    ...
    public static String replaceAll(String str, Pattern pattern, String str2) {
        return O.anyNull(str, pattern, str2) ? str : pattern.matcher(str).replaceAll(str2);
    }
    ...
    public static String replacePattern(String str, String str2, String str3) {
        return O.anyNull(str, str2, str3) ? str : dotAllMatcher(str2, str).replaceAll(str3);
    }
    ...
    public static String replaceAll(String str, String str2, String str3) {
        return O.anyNull(str, str2, str3) ? str : str.replaceAll(str2, str3);
    }
}
