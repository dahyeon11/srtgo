...
public class ReflectionFactory {
    ...
    public KType typeOf(KClassifier kClassifier, List<KTypeProjection> list, boolean z8) {
        return new TypeReference(kClassifier, list, z8);
    }

    public KTypeParameter typeParameter(Object obj, String str, KVariance kVariance, boolean z8) {
