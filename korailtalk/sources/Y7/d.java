...
public class d {
    ...
    private static final String[][] f5661a;

    /* renamed from: b, reason: collision with root package name */
    private static final String[][] f5662b;

    /* renamed from: c, reason: collision with root package name */
    private static final String[][] f5663c;

    /* renamed from: d, reason: collision with root package name */
    private static final String[][] f5664d;

    /* renamed from: e, reason: collision with root package name */
    private static final String[][] f5665e;

    /* renamed from: f, reason: collision with root package name */
    private static final String[][] f5666f;

    /* renamed from: g, reason: collision with root package name */
    private static final String[][] f5667g;

    /* renamed from: h, reason: collision with root package name */
    private static final String[][] f5668h;

    /* renamed from: i, reason: collision with root package name */
    private static final String[][] f5669i;

    /* renamed from: j, reason: collision with root package name */
    private static final String[][] f5670j;
    ...
    static {
        ...
        f5663c = strArr2;
        f5664d = invert(strArr2);
        String[][] strArr3 = {new String[]{"\"", "&quot;"}, new String[]{"&", "&amp;"}, new String[]{SimpleComparison.LESS_THAN_OPERATION, "&lt;"}, new String[]{SimpleComparison.GREATER_THAN_OPERATION, "&gt;"}};
        f5665e = strArr3;
        f5666f = invert(strArr3);
        String[][] strArr4 = {new String[]{"'", "&apos;"}};
        f5667g = strArr4;
        f5668h = invert(strArr4);
        String[][] strArr5 = {new String[]{"\b", "\\b"}, new String[]{X.LF, "\\n"}, new String[]{"\t", "\\t"}, new String[]{"\f", "\\f"}, new String[]{X.CR, "\\r"}};
        f5669i = strArr5;
        f5670j = invert(strArr5);
    }

    public static String[][] APOS_ESCAPE() {
        return (String[][]) f5667g.clone();
    }

    public static String[][] APOS_UNESCAPE() {
        return (String[][]) f5668h.clone();
    }

    public static String[][] BASIC_ESCAPE() {
        return (String[][]) f5665e.clone();
    }

    public static String[][] BASIC_UNESCAPE() {
        return (String[][]) f5666f.clone();
    }

    public static String[][] HTML40_EXTENDED_ESCAPE() {
        return (String[][]) f5663c.clone();
    }

    public static String[][] HTML40_EXTENDED_UNESCAPE() {
        return (String[][]) f5664d.clone();
    }

    public static String[][] ISO8859_1_ESCAPE() {
        return (String[][]) f5661a.clone();
    }

    public static String[][] ISO8859_1_UNESCAPE() {
        return (String[][]) f5662b.clone();
    }

    public static String[][] JAVA_CTRL_CHARS_ESCAPE() {
        return (String[][]) f5669i.clone();
    }

    public static String[][] JAVA_CTRL_CHARS_UNESCAPE() {
        return (String[][]) f5670j.clone();
    }
