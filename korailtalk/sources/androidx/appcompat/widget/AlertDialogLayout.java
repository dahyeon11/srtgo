...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private static int u(View view) {
        int minimumHeight = AbstractC0985p0.getMinimumHeight(view);
        if (minimumHeight > 0) {
    ...
    private boolean v(int i8, int i9) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == AbstractC5568f.topPanel) {
                    view = childAt;
                } else if (id == AbstractC5568f.buttonPanel) {
                    view2 = childAt;
                } else {
                    if ((id != AbstractC5568f.contentPanel && id != AbstractC5568f.customPanel) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            view2.measure(i8, 0);
            iU = u(view2);
            measuredHeight = view2.getMeasuredHeight() - iU;
            paddingTop += iU;
        ...
        if (view2 != null) {
            int i12 = paddingTop - iU;
            int iMin = Math.min(i11, measuredHeight);
            if (iMin > 0) {
                i11 -= iMin;
                iU += iMin;
            }
            view2.measure(i8, View.MeasureSpec.makeMeasureSpec(iU, 1073741824));
    ...
    */
    protected void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r2 = r11
        L7e:
            int r3 = androidx.core.view.AbstractC0985p0.getLayoutDirection(r17)
            int r2 = androidx.core.view.A.getAbsoluteGravity(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L98
            r3 = 5
