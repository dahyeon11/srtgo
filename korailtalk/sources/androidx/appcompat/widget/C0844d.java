...
public class C0844d extends AutoCompleteTextView implements InterfaceC0973l0 {

    /* renamed from: c */
    private static final int[] f7095c = {R.attr.popupBackground};

    /* renamed from: a */
    private final C0845e f7096a;

    /* renamed from: b */
    private final I f7097b;

    public C0844d(Context context) {
        this(context, null);
    }
    ...
    public C0844d(Context context, AttributeSet attributeSet, int i8) {
        ...
        r0 r0VarObtainStyledAttributes = r0.obtainStyledAttributes(getContext(), attributeSet, f7095c, i8, 0);
