...
public abstract class a {
    ...
    public static void applyTheme(Drawable drawable, Resources.Theme theme) {
        C0136a.a(drawable, theme);
    }

    public static boolean canApplyTheme(Drawable drawable) {
        return C0136a.b(drawable);
    }
    ...
    public static void inflate(Drawable drawable, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        C0136a.d(drawable, resources, xmlPullParser, attributeSet, theme);
    }
    ...
    public static void setAutoMirrored(Drawable drawable, boolean z8) {
        drawable.setAutoMirrored(z8);
    }

    public static void setHotspot(Drawable drawable, float f8, float f9) {
        C0136a.e(drawable, f8, f9);
    }

    public static void setHotspotBounds(Drawable drawable, int i8, int i9, int i10, int i11) {
        C0136a.f(drawable, i8, i9, i10, i11);
    }
    ...
    public static void setTint(Drawable drawable, int i8) {
        C0136a.g(drawable, i8);
    }

    public static void setTintList(Drawable drawable, ColorStateList colorStateList) {
        C0136a.h(drawable, colorStateList);
    }

    public static void setTintMode(Drawable drawable, PorterDuff.Mode mode) {
        C0136a.i(drawable, mode);
    }
