...
final class Types {
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            for (int i8 = 1; i8 < this.typeArguments.length; i8++) {
                sb.append(", ");
                sb.append(Types.typeToString(this.typeArguments[i8]));
            }
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if (type3 instanceof ParameterizedType) {
            ...
            boolean z8 = typeResolve3 != ownerType;
            Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
            int length = actualTypeArguments.length;
            for (int i8 = 0; i8 < length; i8++) {
                Type typeResolve4 = resolve(type, cls, actualTypeArguments[i8]);
                if (typeResolve4 != actualTypeArguments[i8]) {
                    if (!z8) {
                        actualTypeArguments = (Type[]) actualTypeArguments.clone();
                        z8 = true;
                    }
                    actualTypeArguments[i8] = typeResolve4;
                }
            }
            return z8 ? new ParameterizedTypeImpl(typeResolve3, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
        }
