...
public class C6176a extends ViewOnFocusChangeListenerC6177b {
    ...
    private void J0() {
        this.f35777j0.setFilters(new InputFilter[]{new InputFilter.LengthFilter(30)});
        this.f35777j0.setInputType(32);
    }

    private void K0() {
        this.f35776i0.setText(this.f35772e0.getTitle(1));
        this.f35779l0.setText(getString(AbstractC5959j.email_number_save));
    }

    public static Fragment newInstance(Bundle bundle) {
        C6176a c6176a = new C6176a();
        c6176a.setArguments(bundle);
        return c6176a;
    }

    private void y0() {
        if (H.getString(getApplicationContext(), "KEY_LOGIN_TYPE").equals(StbkAcntDao.CHANGE_PASSWORD)) {
