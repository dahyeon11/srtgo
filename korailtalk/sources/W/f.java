...
public class f implements u {
    ...
    static boolean a(C6372C c6372c) {
        ...
        return "SAMSUNG".equals(str.toUpperCase(locale)) && AFFECTED_MODELS.contains(Build.MODEL.toUpperCase(locale)) && ((Integer) c6372c.get(CameraCharacteristics.LENS_FACING)).intValue() == 1;
    }
}
